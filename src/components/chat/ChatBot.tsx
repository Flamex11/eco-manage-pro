    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 right-6 w-14 h-14 rounded-full gradient-primary text-white shadow-elegant hover:shadow-glow transition-smooth z-50"
        >
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-6 right-6 w-80 h-96 shadow-elegant border-border/50 z-50 flex flex-col">
            ...
            <div className="p-3 border-t border-border">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 bg-background border-border focus:ring-primary text-sm"
                />
                <Button
                  onClick={handleSendMessage}
                  size="sm"
                  className="px-3 gradient-primary text-white"
